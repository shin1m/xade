...
t_object* t_type_of<zwlr_layer_shell_v1_layer>::f_define(t_library* a_library)
{
	...
	{
		a_fields
		(L"BACKGROUND", ZWLR_LAYER_SHELL_V1_LAYER_BACKGROUND)
		(L"BOTTOM", ZWLR_LAYER_SHELL_V1_LAYER_BOTTOM)
		(L"TOP", ZWLR_LAYER_SHELL_V1_LAYER_TOP)
		(L"OVERLAY", ZWLR_LAYER_SHELL_V1_LAYER_OVERLAY)
		;
	});
}
...
t_object* t_type_of<zwlr_layer_surface_v1_anchor>::f_define(t_library* a_library)
{
	...
	{
		a_fields
		(L"TOP", ZWLR_LAYER_SURFACE_V1_ANCHOR_TOP)
		(L"BOTTOM", ZWLR_LAYER_SURFACE_V1_ANCHOR_BOTTOM)
		(L"LEFT", ZWLR_LAYER_SURFACE_V1_ANCHOR_LEFT)
		(L"RIGHT", ZWLR_LAYER_SURFACE_V1_ANCHOR_RIGHT)
		;
	});
}
...
t_object* t_type_of<zwlr_layer_surface_v1_keyboard_interactivity>::f_define(t_library* a_library)
{
	...
	{
		a_fields
		(L"NONE", ZWLR_LAYER_SURFACE_V1_KEYBOARD_INTERACTIVITY_NONE)
		(L"EXCLUSIVE", ZWLR_LAYER_SURFACE_V1_KEYBOARD_INTERACTIVITY_EXCLUSIVE)
		(L"ON_DEMAND", ZWLR_LAYER_SURFACE_V1_KEYBOARD_INTERACTIVITY_ON_DEMAND)
		;
	});
}
